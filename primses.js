...
// * **Problem Statement:** Assume you have the `fetchData(id)` function from Challenge 15. 
// Use `Promise.all()` to concurrently fetch data for `id`s 1, 2, and 3. 
// Log all resolved data or log the first error if any promise rejects.
